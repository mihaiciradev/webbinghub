...
const en: Translations = {
  ...
  hero: {
    ...
    body:       'We build custom websites and digital tools that help your business grow online. No templates, no guesswork — just the right solution for your goals, built properly and supported long after launch.',
  ...
  pages: {
    about: {
      ...
      heroSub:      'Born from a hobby turned profession — we build websites that speak volumes, and we mean every pixel of it.',
      storyLabel:   'Our story',
      storyTitle:   'Passion & expertise,',
      storyTitleEm: 'fused.',
      ctaTitle:     'Your partner in',
      ctaTitleEm:   'digital growth.',
      ctaSub:       "Ready to talk? No pressure, no pitch. Just an honest conversation about your business and whether we're the right fit.",
    ...
    contact: {
      ...
      title:     "Let's have",
      titleEm:   'a chat.',
      desc:      "Maybe you need a website, maybe you don't. Maybe it has to be a complex one, maybe not. Let's discuss and decide together what suits you best — no pressure, no pitch.",
      formTitle: "Drop your email — we'll reach out within 24h.",
    ...
    blog: {
      ...
      heroTitle: 'We try to contribute.',
      heroTitleEm: 'Because we care.',
      heroSub:   "The web moves fast. We write about what we learn, what we build, and what we think businesses should know before they make decisions about their online presence. No fluff — just useful stuff.",
